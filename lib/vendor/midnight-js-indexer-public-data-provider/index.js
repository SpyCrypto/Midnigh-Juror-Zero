...
import { ContractState } from '../compact-runtime/dist/index.js';
import { LedgerParameters, Transaction, ZswapChainState } from '../ledger-v8/index.js';
import { InvalidProtocolSchemeError, SucceedEntirely, FailFallible, FailEntirely, SegmentSuccess, SegmentFail } from '../midnight-js-types/index.js';
...
const deserializeLedgerParameters = (s) => LedgerParameters.deserialize(toByteArray(s));
