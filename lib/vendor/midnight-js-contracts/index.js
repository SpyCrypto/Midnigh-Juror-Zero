import { createCircuitContext, ContractState as ContractState$1, StateValue as StateValue$1, sampleSigningKey } from '../compact-runtime/dist/index.js';
import { Transaction, makeContractExecutableRuntime, asEffectOption, asContractAddress, exitResultOrError, SucceedEntirely } from '../midnight-js-types/index.js';
import { ContractExecutable } from '../compact-js/index.js';
...
import { ProvableCircuitId, VerifierKey } from '../compact-js/effect/Contract.js';
import { ZswapTransient, ZswapInput, ZswapOffer, ZswapOutput, PreTranscript, PrePartitionContractCall, communicationCommitmentRandomness, ContractDeploy, Intent, ContractState, StateValue, QueryContext, ChargedState } from '../ledger-v8/index.js';
import { ChargedState as ChargedState$1 } from '../onchain-runtime-v3/midnight_onchain_runtime_wasm_bg.js';
...
const createUnprovenLedgerCallTx = (circuitId, contractAddress, initialContractState, zswapChainState, publicTranscript, privateTranscriptOutputs, input, output, nextZswapLocalState, encryptionPublicKey, ledgerParameters, coinPublicKey) => {
    ...
    const call = new PrePartitionContractCall(contractAddress, circuitId, op, preTranscript, privateTranscriptOutputs, input, output, communicationCommitmentRandomness(), circuitId);
    return Transaction.fromPartsRandomized(getNetworkId(), zswapStateToOffer(nextZswapLocalState, encryptionPublicKey, {
        contractAddress,
        zswapChainState
    }), undefined).addCalls({ tag: 'random' }, [call], ledgerParameters, ttlOneHour());
};
...
class TransactionContextImpl {
    ...
    [MergeUnsubmittedCallTxData](circuitId, callData, privateStateId) {
        ...
        contractState.data = new ChargedState$1(StateValue$1.decode(callData.public.nextContractState.encode()));
    ...
    try {
        ...
        return {
            ...
            private: {
                ...
                unprovenTx: createUnprovenLedgerCallTx(options.circuitId, contractAddress, initialContractState, initialZswapChainState, publicTranscript, privateTranscriptOutputs, input, output, zswapLocalState, encryptionPublicKeyForZswapState(zswapLocalState, options.coinPublicKey, walletEncryptionPublicKey), ledgerParameters, coinPublicKey),
